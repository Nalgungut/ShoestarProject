...
<c:set var="email"  value="${fn:split(adminMember.adm_email,'@')}" /> <!-- DB에서 불러오는 풀네임 email값에서 @를 분리시켜줌 -->
<!DOCTYPE html>
   <html>
      <head>
         <meta charset="UTF-8">
      ...
      <!--    <link rel="stylesheet" type="text/css" href="../css/bootstrap.css"> -->
         ...
         <!-- jQuery프레임워크 참조 -->         
           ...
           <script type="text/javascript" src="/resources/include/js/adminModify.js"></script>
           ...
           <script type="text/javascript">
				function adminCodeCheck(){
		       	...
		       	adminLoginUserId = "${member.adm_id}";
				function emailCheck(){
					var adm_email = "${email[1]}";
					$("#emailDomain").val(adm_email).prop("selected", "true");
				}
			</script>
		</head>
	<body>
			...
			<div class="well">
				<form id="adminMemberForm" class="form-horizontal">
					...
					<div class="form-group form-group-sm">
						<label for="adm_id" class="col-sm-2 control-label">아이디</label>
						<div class="col-sm-3">
							${adminMember.adm_id}
						</div>
					</div>
					...
					<div class="form-group form-group-sm">
						<label for="adm_oldUserPwd" class="col-sm-2 control-label">기존 비밀번호</label>
							<div class="col-sm-3">
								<input type="password" id="adm_oldUserPwd" name="adm_oldUserPwd" maxlength="15" 
					...
					<div class="form-group form-group-sm">
						<label for="adm_pwd" class="col-sm-2 control-label">변경할 비밀번호</label>
							<div class="col-sm-3">
					...
					<div class="form-group form-group-sm">
						<label for="adminUserPwdCheck" class="col-sm-2 control-label">비밀번호 확인</label>
							<div class="col-sm-3">
								<input type="password" id="adminUserPwdCheck" name="adminUserPwdCheck" maxlength="15" 
								class="form-control" placeholder="변경할 비밀번호 입력">
							</div>
					...
					<div class="form-group form-group-sm">
						<label for="adm_phone" class="col-sm-2 control-label">휴대폰번호</label>
							<div class="col-sm-3">
								...
								class="form-control" placeholder="변경할 비밀번호 입력" value="${adminMember.adm_phone}">
							</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-6">
							<input type="button" value="확인" id="adminModify"  class="btn btn-default"/>
							<input type="button" value="재작성" id="adminModifyReset" class="btn btn-default"/>
							<input type="button" value="취소" id="adminModifyCancel" class="btn btn-default"/>
						</div>
					</div>
